...
// Force redeploy - v3 - uses Cobalt API instead of ytdl
export const runtime = 'nodejs'
export const dynamic = 'force-dynamic'
export const maxDuration = 60

// #region agent log
console.log('[DEBUG] Landing download module loaded - v3');
// #endregion
...
export async function GET(request: NextRequest) {
  // #region agent log
  console.log('[DEBUG] download API called - v3 (Cobalt)');
  // #endregion
  ...
  try {
    ...
    // #region agent log
    console.log('[DEBUG] Cobalt response status:', cobaltResponse.status);
    // #endregion
    
    if (!cobaltResponse.ok) {
      const errorText = await cobaltResponse.text()
      console.error('[DEBUG] Cobalt API error:', errorText)
    ...
    // #region agent log
    console.log('[DEBUG] Cobalt data status:', cobaltData.status);
    // #endregion
    ...
    // #region agent log
    console.log('[DEBUG] Redirecting to download URL');
    // #endregion
    ...
    console.error('[DEBUG] Download error:', errorMessage)
